...
import BookLight from 'assets/images/book/book-light.svg';
  ...
  return (
    <div className="relative m-auto" style={{ height: '100%', width: '228px' }}>
      <img
        ...
        src={theme === 'light' ? BookLight : BookDark}
      />
      <Circle
        radius={'10px'}
        angle={'0deg'}
      ...
      />
      <div
        className="center-with-flex absolute dark:bg-black bg-white rounded-full"
        style={{
          width: '168px',
          height: '168px',
          bottom: '286px',
